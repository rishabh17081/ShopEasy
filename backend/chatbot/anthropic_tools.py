        ...
        for tool_call in tool_calls:
            ...
            if tool_name in tool_map:
                ...
                try:
                    ...
                    if tool_name.startswith("list_") or tool_name in ["create_invoice", "send_invoice", "send_invoice_reminder", "cancel_sent_invoice", "create_product", "update_product", "create_subscription_plan", "create_order", "get_order", "create_shipment", "get_shipment_tracking"]:
