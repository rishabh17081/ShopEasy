...
VALUES (1, 'AMEX', '371449635398431', '8431', '01/2030', 'John Doe', 1, 'SUB-1A9B1DB446', '2025-03-11 17:29:21')
''')

cursor.execute('''
INSERT INTO cards (user_id, card_type, card_number, last_four, expiry_date, cardholder_name, is_default, subscription_id, created_at)
VALUES (1, 'AMEX', '371234806987034', '7034', '01/2024', 'John Doe', 0, 'SUB-DF1885C7E4', '2025-03-11 17:29:21')
''')
