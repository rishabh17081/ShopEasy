...
async def root():
    ...
    return {
        ...
        "version": "1.0.0",
        "endpoints": [
            {"path": "/webhooks/card-updated", "method": "POST",
             "description": "Handle PayPal card update webhooks (original format)"},
            {"path": "/paypal-webhooks", "method": "POST",
             "description": "Handle PayPal card update webhooks (new format)"},
